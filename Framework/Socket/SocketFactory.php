...
class SocketFactory
{
     ...
     * @return \\App\Framework\Socket\Socket
     * @throws InvalidArgument\Exception if given address is invalid
    ...
    public function createFromString(&$address, &$scheme)
    {
        ...
        if ($scheme === 'tcp') {
            ...
            throw new InvalidArgument\Exception('Invalid address scheme given');
        }
        return $socket;
    }
}